...
<?//echo "<pre>"; print_r($arResult["PROPERTIES"]["DOC"]); echo "</pre>";?>

<?if($arResult["PROPERTIES"]["DOC"]["FILE_VALUE"]):?>
<div class="exam-review-doc">
	<p><?=GetMessage("DOC")?></p>
	<?foreach($arResult["DISPLAY_PROPERTIES"]["DOC"]["FILE_VALUE"] as $pid=>$arProperty):?>
